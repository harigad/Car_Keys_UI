...
function Controller() {
    ...
    $.__views.search_bar.add($.__views.__alloyId27);
    ...
    $.__views.__alloyId27.add($.__views.search);
    ...
    $.__views.__alloyId27.add($.__views.cancel_btn);
    ...
    $.__views.cancel_btn.add($.__views.__alloyId28);
    $.__views.__alloyId29 = Ti.UI.createScrollView({
        height: Ti.UI.FILL,
        top: "50",
        id: "__alloyId29"
    });
    $.__views.share_add_edit.add($.__views.__alloyId29);
    $.__views.friends = Ti.UI.createTableView({
        id: "friends"
    });
    $.__views.__alloyId29.add($.__views.friends);
