...
function Controller() {
    ...
    $.__views.comment.add($.__views.__alloyId37);
    ...
    onCancel ? $.__views.__alloyId38.addEventListener("click", onCancel) : __defers["$.__views.__alloyId38!click!onCancel"] = true;
    ...
    $.__views.__alloyId37.add($.__views.question);
    ...
    onSave ? $.__views.__alloyId40.addEventListener("click", onSave) : __defers["$.__views.__alloyId40!click!onSave"] = true;
    ...
    $.comment.open();
    $.text.focus();
    __defers["$.__views.__alloyId38!click!onCancel"] && $.__views.__alloyId38.addEventListener("click", onCancel);
    __defers["$.__views.__alloyId40!click!onSave"] && $.__views.__alloyId40.addEventListener("click", onSave);
    _.extend($, exports);
}
