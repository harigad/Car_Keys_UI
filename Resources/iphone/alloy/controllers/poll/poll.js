...
function Controller() {
    ...
    $.__views.topView.add($.__views.__alloyId140);
    ...
    $.__views.bottomView.add($.__views.__alloyId141);
    $.__views.options = Ti.UI.createView({
        id: "options",
        layout: "vertical",
        height: Ti.UI.SIZE
    });
    $.__views.__alloyId141.add($.__views.options);
    ...
    $.__views.__alloyId142.add($.__views.comments);
    $.__views.__alloyId143 = Ti.UI.createView({
        height: Ti.UI.SIZE,
        id: "__alloyId143"
    });
    $.__views.__alloyId142.add($.__views.__alloyId143);
    addComment ? $.__views.__alloyId143.addEventListener("click", addComment) : __defers["$.__views.__alloyId143!click!addComment"] = true;
    ...
    $.__views.__alloyId143.add($.__views.add_comment);
    ...
    __defers["$.__views.__alloyId143!click!addComment"] && $.__views.__alloyId143.addEventListener("click", addComment);
    _.extend($, exports);
}
