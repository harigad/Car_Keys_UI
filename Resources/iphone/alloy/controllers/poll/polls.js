...
function Controller() {
    ...
    more ? $.__views.__alloyId144.addEventListener("click", more) : __defers["$.__views.__alloyId144!click!more"] = true;
    ...
    __defers["$.__views.__alloyId144!click!more"] && $.__views.__alloyId144.addEventListener("click", more);
    _.extend($, exports);
}
