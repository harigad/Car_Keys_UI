...
function Controller() {
    ...
    openMap ? $.__views.__alloyId148.addEventListener("click", openMap) : __defers["$.__views.__alloyId148!click!openMap"] = true;
    ...
    $.__views.__alloyId148.add($.__views.address_line);
    ...
    $.__views.__alloyId148.add($.__views.city_state);
    ...
    $.__views.__alloyId149.add($.__views.map);
    ...
    __defers["$.__views.__alloyId148!click!openMap"] && $.__views.__alloyId148.addEventListener("click", openMap);
