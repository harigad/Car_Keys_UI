...
function Controller() {
    ...
    $.__views.home_menu.add($.__views.__alloyId155);
    goToMyCars ? $.__views.__alloyId155.addEventListener("click", goToMyCars) : __defers["$.__views.__alloyId155!click!goToMyCars"] = true;
    ...
    $.__views.__alloyId156.add($.__views.cars);
    ...
    $.__views.home_menu.add($.__views.__alloyId158);
    goToFriends ? $.__views.__alloyId158.addEventListener("click", goToFriends) : __defers["$.__views.__alloyId158!click!goToFriends"] = true;
    ...
    $.__views.__alloyId159.add($.__views.friends);
    ...
    $.__views.home_menu.add($.__views.__alloyId161);
    ...
    __defers["$.__views.__alloyId155!click!goToMyCars"] && $.__views.__alloyId155.addEventListener("click", goToMyCars);
    __defers["$.__views.__alloyId158!click!goToFriends"] && $.__views.__alloyId158.addEventListener("click", goToFriends);
    _.extend($, exports);
}
