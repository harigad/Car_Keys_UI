...
function Controller() {
    ...
    $.__views.search_bar.add($.__views.__alloyId164);
    ...
    $.__views.__alloyId164.add($.__views.search);
    ...
    $.__views.__alloyId164.add($.__views.cancel_btn);
    ...
    $.__views.cancel_btn.add($.__views.__alloyId165);
    $.__views.__alloyId166 = Ti.UI.createScrollView({
        height: Ti.UI.FILL,
        top: "50",
        id: "__alloyId166"
    });
    $.__views.ridealong.add($.__views.__alloyId166);
    $.__views.friends = Ti.UI.createTableView({
        id: "friends"
    });
    $.__views.__alloyId166.add($.__views.friends);
