...
function Controller() {
    ...
    $.__views.show_search_carkey_results_for_ridealong.add($.__views.__alloyId119);
    ...
    onCancel ? $.__views.__alloyId121.addEventListener("click", onCancel) : __defers["$.__views.__alloyId121!click!onCancel"] = true;
    ...
    $.__views.__alloyId120.add($.__views.question);
    ...
    __defers["$.__views.__alloyId121!click!onCancel"] && $.__views.__alloyId121.addEventListener("click", onCancel);
    _.extend($, exports);
}
