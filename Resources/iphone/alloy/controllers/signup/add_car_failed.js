...
function Controller() {
    ...
    $.__views.add_car_failed.add($.__views.__alloyId125);
    ...
    onOk ? $.__views.__alloyId127.addEventListener("click", onOk) : __defers["$.__views.__alloyId127!click!onOk"] = true;
    ...
    $.add_car_failed.open();
    __defers["$.__views.__alloyId127!click!onOk"] && $.__views.__alloyId127.addEventListener("click", onOk);
    _.extend($, exports);
}
