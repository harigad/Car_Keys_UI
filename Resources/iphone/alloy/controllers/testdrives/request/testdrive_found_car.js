...
function Controller() {
    ...
    this.__controllerPath = "testdrives/request/testdrive_found_car";
    if (arguments[0]) {
    ...
    var exports = {};
    var __defers = {};
    $.__views.testdrive_found_car = Ti.UI.createWindow({
        backgroundColor: "#f1f1f1",
        navBarHidden: true,
        id: "testdrive_found_car"
    });
    $.__views.testdrive_found_car && $.addTopLevelView($.__views.testdrive_found_car);
    $.__views.bgImage = Ti.UI.createImageView({
        id: "bgImage"
    });
    $.__views.testdrive_found_car.add($.__views.bgImage);
    ...
    $.__views.testdrive_found_car.add($.__views.main);
