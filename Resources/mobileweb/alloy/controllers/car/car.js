...
function Controller() {
    function draw() {
        ...
        $.owner_name.setText(_owner_name + "'s");
        $.model_name.setText(_data.model);
        $.cylinder.setText("V." + _data.cylinder);
    ...
    $.__views.model.add($.__views.__alloyId2);
    ...
    $.__views.__alloyId2.add($.__views.owner_name);
    ...
    $.__views.__alloyId2.add($.__views.model_name);
    ...
    $.__views.logo.add($.__views.__alloyId4);
    ...
    $.__views.__alloyId4.add($.__views.logo_image);
    ...
    $.__views.__alloyId6.add($.__views.mileage);
    ...
    goToCylinder ? $.__views.__alloyId7.addEventListener("click", goToCylinder) : __defers["$.__views.__alloyId7!click!goToCylinder"] = true;
    ...
    $.__views.__alloyId7.add($.__views.cylinder);
    ...
    $.__views.__alloyId9.add($.__views.hp);
    ...
    $.__views.__alloyId10.add($.__views.recalls);
    ...
    var _owner_name = args._owner_name;
    args._editable;
    args._callBack;
    ...
    __defers["$.__views.__alloyId7!click!goToCylinder"] && $.__views.__alloyId7.addEventListener("click", goToCylinder);
    _.extend($, exports);
}
