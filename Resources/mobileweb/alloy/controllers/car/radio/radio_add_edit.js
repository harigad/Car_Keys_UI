...
function Controller() {
    ...
    $.__views.radio_add_edit.add($.__views.__alloyId15);
    ...
    $.__views.__alloyId15.add($.__views.plate);
    ...
    onEdit ? $.__views.__alloyId17.addEventListener("click", onEdit) : __defers["$.__views.__alloyId17!click!onEdit"] = true;
    ...
    onCancel ? $.__views.__alloyId19.addEventListener("click", onCancel) : __defers["$.__views.__alloyId19!click!onCancel"] = true;
    ...
    __defers["$.__views.__alloyId17!click!onEdit"] && $.__views.__alloyId17.addEventListener("click", onEdit);
    __defers["$.__views.__alloyId19!click!onCancel"] && $.__views.__alloyId19.addEventListener("click", onCancel);
    _.extend($, exports);
}
