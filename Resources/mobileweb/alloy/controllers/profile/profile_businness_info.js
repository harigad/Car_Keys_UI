...
function Controller() {
    ...
    openMap ? $.__views.__alloyId100.addEventListener("click", openMap) : __defers["$.__views.__alloyId100!click!openMap"] = true;
    ...
    $.__views.__alloyId100.add($.__views.address_line);
    ...
    $.__views.__alloyId100.add($.__views.city_state);
    ...
    $.__views.__alloyId101.add($.__views.map);
    ...
    __defers["$.__views.__alloyId100!click!openMap"] && $.__views.__alloyId100.addEventListener("click", openMap);
