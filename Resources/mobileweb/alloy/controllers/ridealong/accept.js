function Controller() {
    ...
    $.__views.accept.add($.__views.__alloyId55);
    ...
    $.__views.__alloyId55.add($.__views.request);
    ...
    onAccept ? $.__views.__alloyId56.addEventListener("click", onAccept) : __defers["$.__views.__alloyId56!click!onAccept"] = true;
    ...
    onDelete ? $.__views.__alloyId58.addEventListener("click", onDelete) : __defers["$.__views.__alloyId58!click!onDelete"] = true;
    ...
    $.accept.open();
    __defers["$.__views.__alloyId56!click!onAccept"] && $.__views.__alloyId56.addEventListener("click", onAccept);
    __defers["$.__views.__alloyId58!click!onDelete"] && $.__views.__alloyId58.addEventListener("click", onDelete);
    _.extend($, exports);
}
