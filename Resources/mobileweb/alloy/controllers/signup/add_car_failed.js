function Controller() {
    ...
    $.__views.add_car_failed.add($.__views.__alloyId69);
    ...
    onOk ? $.__views.__alloyId71.addEventListener("click", onOk) : __defers["$.__views.__alloyId71!click!onOk"] = true;
    ...
    $.add_car_failed.open();
    __defers["$.__views.__alloyId71!click!onOk"] && $.__views.__alloyId71.addEventListener("click", onOk);
    _.extend($, exports);
}
