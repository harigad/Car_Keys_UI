function Controller() {
    ...
    $.__views.not_found_car.add($.__views.__alloyId74);
    ...
    $.__views.__alloyId74.add($.__views.error_label);
    ...
    onOk ? $.__views.__alloyId75.addEventListener("click", onOk) : __defers["$.__views.__alloyId75!click!onOk"] = true;
    ...
    $.not_found_car.open();
    __defers["$.__views.__alloyId75!click!onOk"] && $.__views.__alloyId75.addEventListener("click", onOk);
    _.extend($, exports);
}
