...
function Controller() {
    ...
    $.__views.not_found_car.add($.__views.__alloyId142);
    ...
    $.__views.__alloyId142.add($.__views.error_label);
    ...
    onOk ? $.__views.__alloyId143.addEventListener("click", onOk) : __defers["$.__views.__alloyId143!click!onOk"] = true;
    ...
    $.not_found_car.open();
    __defers["$.__views.__alloyId143!click!onOk"] && $.__views.__alloyId143.addEventListener("click", onOk);
    _.extend($, exports);
}
